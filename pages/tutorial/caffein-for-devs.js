...
for (i = 0; i < 5; i++) {
  ...
  if (!isAlreadyPurchased(user, tutorialData, '610be8cf39197ebea7c6141e'))
    return (
      <>
        <Head>
          {/* now the tab will say exactly what's in the title instead of just something random */}
          <title>Hello Tutorials | Caffeine for Devs</title>
        </Head>
        <StyledPreviewContainer>
          ...
          <AddToCart
            isMatch={user && matchCartCacheToItem('610be8cf39197ebea7c6141e')}
            id="610be8cf39197ebea7c6141e"
          />
        </StyledPreviewContainer>
      </>
    );
