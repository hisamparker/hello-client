...
for (i = 0; i < 5; i++) {
  ...
  if (!isAlreadyPurchased(user, tutorialData, '610be8d039197ebea7c61428'))
    return (
      <>
        <Head>
          {/* now the tab will say exactly what's in the title instead of just something random */}
          <title>Hello Tutorials | React for Babies</title>
        </Head>
        <StyledPreviewContainer>
          ...
          <AddToCart
            isMatch={user && matchCartCacheToItem('610be8d039197ebea7c61428')}
            id="610be8d039197ebea7c61428"
          />
        </StyledPreviewContainer>
      </>
    );
